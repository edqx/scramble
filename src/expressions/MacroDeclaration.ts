...
export class MacroDeclarationExpression extends Expression {
    ...
    constructor(public readonly identifier: string, public readonly parameters: Expression[], public readonly block: Expression) {
        super(ExpressionKind.MacroDeclaration, block.position);
    }
}